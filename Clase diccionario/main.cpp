...
int main(int argc, char** argv) {
    ...
    */
    ...
    d.add(std::string("carro"), std::string("vehiculo motorizado de 4 ruedas"));
    d.add(std::string("avion"), std::string("Vehiculo volador mas pesado que el aire."));
    d.add(std::string("avion"), std::string("2da definicion Vehiculo volador mas pesado que el aire."));
    d.add(std::string("carro"), std::string("2da definicion Coche o automovil"));
    d.add(std::string("casa"), std::string("Vivienda donde las personas conviven"));
    d.add(std::string("pizza"), std::string("Comida italiana en redonda, pero triangular que se come con las manos"));
    /*
